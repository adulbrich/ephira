...
import { useMoods, useSelectedDate, useSymptoms, useValues } from "@/assets/src/calendar-storage";
      ...
      <View style={styles.chipContainer}>
        {options.map((option) => (
          <Chip
            ...
            onPress={() => {
              setSelectedValues((selectedValues.includes(option.value) ? selectedValues.filter((val) => val !== option.value) : [...selectedValues, option.value]))
            }}
            style={{
